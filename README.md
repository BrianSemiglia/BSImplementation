...
If you really wanted to, you could put the `initWithImplementationWithName:` and `forwardingTargetForSelector:` in a super class so that your code was just this:
